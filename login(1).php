...
<body>
    ...
    <div class="container" style="display: flex; justify-content: center; align-items: center; min-height: 85vh;">
        <div class="glass-card" style="width: 100%; max-width: 440px; padding: 50px 40px; position: relative; overflow: hidden;">
            <!-- Decorative circle -->
            ...
            <div style="text-align: center; margin-bottom: 35px; position: relative;">
                <div style="background: rgba(255,255,255,0.5); width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; font-size: 2.5rem; box-shadow: 0 10px 20px rgba(0,0,0,0.05); border: 2px solid rgba(255,255,255,0.8);">🦄</div>
            ...
            <div style="margin-top: 30px; text-align: center; color: var(--text-muted); font-size: 0.95rem;">
                ยังไม่มีบัญชีใช่ไหม? <a href="register.php" style="color: var(--primary); font-weight: 600; text-decoration: underline; text-decoration-style: dashed;">สมัครสมาชิกที่นี่</a>
            </div>
        </div>
    </div>
